...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //创建TabBarVc
    LCXTabBarController * tabVC = [[LCXTabBarController alloc]init];
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "cn.xi.Shopping" in the application's documents directory.
